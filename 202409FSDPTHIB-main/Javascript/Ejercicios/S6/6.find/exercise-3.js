...
let cucushumuAlien = aliens.find(alien => alien.name === 'Cucushumushu');
let porompomperoMutation = mutations.find(mutation => mutation.name === 'Porompompero');

cucushumuAlien.mutation = porompomperoMutation;
console.log(cucushumuAlien);